...
taskbar=pygame.transform.scale(pygame.image.load(os.path.join("Assets",'taskbar.jpg')),(800,50))
class Brush():
    def __init__(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if pygame.mouse.get_pressed()[0]:
                    if 685.64 <= pygame.mouse.get_pos()[1] <= 755.81 and 0.3 <= pygame.mouse.get_pos()[0] <= 89.54:
