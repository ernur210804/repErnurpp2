...
tenge_surf = pygame.image.load(os.path.join("Assets","tenge.png"))
tenge_surf = pygame.transform.scale(tenge_surf, (tenge_surf.get_width()//6 ,tenge_surf.get_height()//6))

bitcoin_surf = pygame.image.load(os.path.join("Assets",'bitcoin.png'))
...
class Bitcoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(os.path.join("Assets",'bitcoin.png'))
...
class coin(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(os.path.join("Assets","tenge.png"))
